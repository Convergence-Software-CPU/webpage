...
!function (t, e) {
      ...
      for (var i in n)
        if (Object.prototype.hasOwnProperty.call(n, i)) {
          ...
          if (!new RegExp(o).test(a))
            throw new Error(
              t.toUpperCase() + ': Option "' + i + '" provided type "' + a + '" but expected ' +
              'type "' + o + '".'
            )
        }
      var s
      ...
      return e.toggle = function () {
        ...
        if (n) {
          ...
          if (o) {
            ...
            t && (
              "checkbox" !== o.type && "radio" !== o.type || (o.checked = !this._element.classList.contains("active")),
  ...
  i
    ...
    .on("click.bs.button.data-api", '[data-toggle^="button"]', (function (t) {
      ...
      if (
        ...
        "INPUT" !== n.tagName && "LABEL" === e.tagName || h
          ._jQueryInterface
          .call(i.default(e), "toggle", "INPUT" === n.tagName)
      }
    }))
    .on(
      ...
      return e.next = function () {
        ...
        e.pause = function (t) {
          t || (this._isPaused = !0),
            this
              ._element
              .querySelector(".carousel-item-next, .carousel-item-prev") && (
        ...
        e.to = function (t) {
          ...
          this._activeElement = this
            ._element
            .querySelector(".active.carousel-item");
        ...
        e._getItemIndex = function (t) {
          return this._items = t && t.parentNode
            ? []
              .slice
              .call(t.parentNode.querySelectorAll(".carousel-item"))
            : [],
            this
              ._items
              .indexOf(t)
        ...
        e._setActiveIndicatorElement = function (t) {
          if (this._indicatorsElement) {
            var e = []
              .slice
              .call(this._indicatorsElement.querySelectorAll(".active"));
            i
              .default(e)
              .removeClass("active");
            var n = this
        ...
        this._isTransitioning = !1,
          ...
          this._triggerArray = []
            ...
            .call(document.querySelectorAll(
              '[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-t' +
              'arget="#' + t.id + '"]'
            ));
        for (
      ...
      return e.toggle = function () {
        ...
        e.show = function () {
          ...
          if (!this._isTransitioning && !i.default(this._element).hasClass("show") && (
            this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter((function (t) {
  ...
  function x(t) {
    ...
    var e = I(t),
      ...
      i = e.overflowX,
      o = e.overflowY;
    return /(auto|scroll|overlay)/.test(n + o + i)
      ? t
      : x(O(t))
  }
  function j(t) {
    return t && t.referenceNode
      ? t.referenceNode
      : t
  }
  ...
  function R(t) {
    ...
    for (
      var e = F(10)
        ? document.body
        : null,
      n = t.offsetParent || null; n === e && t.nextElementSibling;
    )
  ...
  function M(t, e) {
    ...
    if (t !== l && e !== l || i.contains(o))
      return "BODY" === (s = (a = l).nodeName) || "HTML" !== s && R(
        a.firstElementChild
      ) !== a
        ? R(l)
        : l;
  ...
  function Q(t, e) {
    var n = "x" === e
      ...
      i = "Left" === n
        ? "Right"
        : "Bottom";
    return parseFloat(t["border" + n + "Width"]) + parseFloat(
      t["border" + i + "Width"]
    )
  }
  function W(t, e, n, i) {
    return Math.max(
      ...
      n["scroll" + t],
      F(10)
        ? parseInt(n["offset" + t]) + parseInt(i["margin" + (
          "Height" === t
            ? "Top"
            : "Left"
        )]) + parseInt(i["margin" + (
  ...
  function ct(t) {
    for (var e = [
      ...
      "Moz",
      "O"
    ], n = t.charAt(0).toUpperCase() + t.slice(1), i = 0; i < e.length; i++) {
      var o = e[i],
        r = o
          ? "" + o + n
          : t;
  ...
  function wt(t, e, n) {
    ...
    if (!o) {
      var r = "`" + e + "`",
        a = "`" + n + "`";
      console.warn(
        a + " modifier is required by " + r + " modifier in order to work, be sure to i" +
        "nclude it before " + r + "!"
      )
    }
    return o
            ...
            d = {
              ...
              secondary: function (t) {
                var n = "right" === t
                  ...
                  : "top",
                  i = f[n];
                return f[t] > l[t] && !e.escapeWithReference && (i = Math.min(f[n], l[t] - (
                  "right" === t
                    ? f.width
                    : f.height
                ))),
        ...
        fn: function (t, e) {
          ...
          return a.forEach((function (s, l) {
            ...
            var u = t.offsets.popper,
              ...
              d = Math.floor,
              c = "left" === i && d(u.right) > d(f.left) || "right" === i && d(u.left) < d(
                f.right
              ) || "top" === i && d(u.bottom) > d(f.top) || "bottom" === i && d(u.top) < d(
                f.bottom
              ),
              h = d(u.left) < d(n.left),
              ...
              b = !!e.flipVariations && (
                _ && "start" === r && h || _ && "end" === r && p || !_ && "start" === r && m || !_ && "end" === r && g
              ),
              y = !!e.flipVariationsByContent && (
                _ && "start" === r && p || _ && "end" === r && h || !_ && "start" === r && g || !_ && "end" === r && m
              ),
              w = b || y;
            (c || v || w) && (
              t.flipped = !0,
      ...
      applyStyle: {
        ...
        fn: function (t) {
          ...
          return bt(t.instance.popper, t.styles),
            ...
            t.arrowElement && Object
              .keys(t.arrowStyles)
              .length && bt(t.arrowElement, t.arrowStyles),
            t
        },
    ...
    It = function () {
      function t(e, n) {
        ...
        V(this, t),
          ...
          Object
            .keys(X({}, t.Defaults.modifiers, o.modifiers))
            .forEach((function (e) {
              i
                .options
                .modifiers[e] = X(
          ...
          return t.hasClass("dropup")
            ...
            : t.hasClass("dropright")
              ...
              : t.hasClass("dropleft")
                ...
                : i
                  .default(this._menu)
                  .hasClass("dropdown-menu-right") && (e = "bottom-end"),
            e
        },
          ...
          return this.each((function () {
            ...
            if (n || (n = new t(
              ...
              "object" == typeof e
                ? e
                : null
            ), i.default(this).data("bs.dropdown", n)), "string" == typeof e) {
      ...
      return e.toggle = function (t) {
        ...
        e.show = function (t) {
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            var n = i
              .default
              .Event("show.bs.modal", { relatedTarget: t });
            i
              .default(this._element)
              .trigger(n),
        ...
        e._showElement = function (t) {
          ...
          var r = i
            .default
            .Event("shown.bs.modal", { relatedTarget: t }),
            a = function () {
              e._config.focus && e
                ._element
                .focus(),
        ...
        e._setScrollbar = function () {
          ...
          if (this._isBodyOverflowing) {
            var e = []
              ...
              n = []
                .slice
                .call(document.querySelectorAll(".sticky-top"));
            i
              .default(e)
              .each((function (e, n) {
        ...
        s.forEach((function (t) {
          (function (t, e) {
            var n = t
              ...
              .toLowerCase();
            if (-1 !== e.indexOf(n))
              return -1 === qt.indexOf(n) || Boolean(
                t.nodeValue.match(Wt) || t.nodeValue.match(Ut)
              );
      ...
      return e.enable = function () {
        ...
        e.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            r.setAttribute("id", a),
              this
                .element
                .setAttribute("aria-describedby", a),
              this.setContent(),
            ...
            i
              ...
              i
                .default
                .contains(this.element.ownerDocument.documentElement, this.tip) || i
                  .default(r)
                  .appendTo(f),
              i
                .default(this.element)
        ...
        e.hide = function (t) {
          var e = this,
            ...
            r = function () {
              "show" !== e._hoverState && n.parentNode && n
                .parentNode
                .removeChild(n),
                e._cleanTipClass(),
                e
        ...
        e._enter = function (t, e) {
          ...
          (e = e || i.default(t.currentTarget).data(n)) || (
            ...
            i
              .default(e.getTipElement())
              .hasClass("show") || "show" === e._hoverState
              ? e._hoverState = "show"
              : (
      ...
      function t(t, e) {
        ...
        this._element = t,
          this._scrollElement = "BODY" === t.tagName
            ...
            : t,
          this._config = this._getConfig(e),
          this._selector = this._config.target + " .nav-link," + this._config.target + " " +
          ".list-group-item," + this._config.target + " .dropdown-item",
          this._offsets = [],
          this._targets = [],
    ...
    pe = function () {
      ...
      return e.show = function () {
        ...
        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && i.default(this._element).hasClass("active") || i.default(this._element).hasClass("disabled"))) {
          ...
          if (o) {
            var a = "UL" === o.nodeName || "OL" === o.nodeName
              ? "> li > .active"
              : ".active";
          ...
          var s = i
            .default
            .Event("hide.bs.tab", { relatedTarget: this._element }),
            u = i
              .default
              .Event("show.bs.tab", { relatedTarget: n });
          if (
            ...
            var f = function () {
              var e = i
                .default
                .Event("hidden.bs.tab", { relatedTarget: t._element }),
                o = i
                  .default
            ...
            e
              ? this._activate(e, e.parentNode, f)
              : f()
          }
        }
      },
        ...
        e._transitionComplete = function (t, e, n) {
          ...
          if (
            ...
            if (r) {
              var a = []
                .slice
                .call(r.querySelectorAll(".dropdown-toggle"));
              i
                .default(a)
                .addClass("active")
            }
